...
def page1():
    os.system(r"C:\Users\HP\AppData\Local\Programs\Python\Python38-32\but.py")
def page2():
    os.system(r"C:\Users\HP\AppData\Local\Programs\Python\Python38-32\but1.py")
...
btns = Button(labelframe, text='Browse',style='W.TButton',command=page1,width=10)
